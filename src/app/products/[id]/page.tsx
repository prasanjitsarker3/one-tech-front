...
const page = () => {
  const productDetailsData = {
    ...
    specification: [
      {
        ...
        specificationData: [
          ...
          { name: "Processor Model", value: "M4 Pro chip" },
          {
            name: "Processor Core",
            value:
              "14 Core CPU with 10 performance cores and 4 efficiency cores 16-core Neural Engine 273GB/s memory bandwidth",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        specificationData: [
          ...
          { name: "Storage Capacity", value: "512GB" },
          {
            ...
            value: "Configurable to: 1TB, 2TB or 4 TB",
          },
        ],
      },
      {
        ...
        specificationData: [
          {
            name: "Graphics Model",
            value: "Apple 20-core GPU (Hardware-accelerated ray tracing)",
          },
      ...
      },
      {
        ...
        specificationData: [
          ...
          {
            name: "Keyboard Features",
            value:
              "78 (U.S.) keys including 12 full-height function keys and 4 arrow keys in an inverted‑T arrangement Touch ID Ambient light sensor",
          },
          {
            name: "TouchPad",
            value:
    ...
    description: [
      {
        title:
          "Apple MacBook Pro 16 inch M4 Pro Chip Liquid Retina XDR Display 48GB RAM 512GB SSD Space Black",
      ...
      {
        title:
          "Stunning Visuals with Liquid Retina XDR Display and ProMotion Technology",
      ...
      {
        title:
          "Buy Apple MacBook Pro 16 inch M4 Pro Chip Liquid Retina XDR Display 48GB RAM 512GB SSD Space Black from Star Tech",
