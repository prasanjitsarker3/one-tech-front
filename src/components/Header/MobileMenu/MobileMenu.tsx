...
const MobileMenu: React.FC<MenuType> = ({ links }) => {
    ...
    return (
        <div className="block md:hidden">
            ...
            <div className={`${isActive ? "h-60 py-5 border-gray-400" : "h-0 py-0 border-transparent"} md:hidden flex flex-col gap-3 absolute w-full left-0 top-[80px] overflow-y-auto border-b bg-white z-50 transition-all duration-500`}>
                {
